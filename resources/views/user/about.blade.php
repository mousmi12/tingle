      ...
      <div class="row">
        <div class="col-12 col-sm-6 d-flex justify-content-center align-items-center">
          <div>
            ...
            <p class="px-4 fontStyle" style="font-size: 35px;">Hi, I’m Mousmi Muthalib! By day, I’m a software developer, but by night, I’m a passionate crafter. I create magical handmade products using yarn and resin. Thank you for supporting my small business and keeping my dream alive!</p>
          </div>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-12 col-sm-6 d-flex justify-content-center align-items-center">
          <div>
            ...
            <p class="fontStyle px-4"  style="font-size: 35px;">Tingle is a haven for unique, handmade creations crafted from yarn and resin. Each piece is designed with meticulous care and creativity, aiming to bring a touch of sparkle and warmth to your life. We believe in the magic of handmade art and the joy it can bring. Thank you for being a part of our journey!</p>
          </div>
        </div>
      </div>
    </section>
