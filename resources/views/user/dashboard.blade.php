      ...
      <div class="row align-items-center">
        <div class="col-12 col-sm-4 py-3 d-flex justify-content-center">
          <div style="width: 80%">
            <div>
              <img
                src="{{asset('/categories/booties.jpg')}}"
            ...
            <div class="d-flex justify-content-between">
              <div>
                <h6 class="fw-bold">Crochet Booties</h6>
                <h6>Explore now</h6>
              </div>
              <div class="d-flex justify-content-center align-items-center">
                <a href="{{ route('user.products', 8) }}"><i
        ...
        <div class="col-12 col-sm-4 py-3 d-flex justify-content-center">
          <div style="width: 80%">
            <div>
              <img
                src="{{asset('/categories/Amigurumi.jpg')}}"
                class="categoryImage rounded-5"
                alt=""
                srcset=""
              />
            ...
            <div class="d-flex justify-content-between">
              <div>
                <h6 class="fw-bold">Amigurumi</h6>
                <h6>Explore now</h6>
              </div>
              <div class="d-flex justify-content-center align-items-center">
              <a href="{{ route('user.products', 7) }}"><i
                  class="bi bi-arrow-right text-secondary"
                  style="font-size: 30px"
                ></i></a>
              </div>
